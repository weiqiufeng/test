...
//        synchronized (this){
//            String yearAndMonthAndDay = DateUtils.getYear() + DateUtils.getMonth()+DateUtils.getDay();
//            SerialNumber serialNumber = serialNumberService.getNumberByTypeAndTimeStr(type, yearAndMonthAndDay);
//            String id = null;
//            if(serialNumber == null){
//                SerialNumber serialNumber1 = new SerialNumber();
//                serialNumber1.setType(type);
//                serialNumber1.setTimeStr(yearAndMonthAndDay);
